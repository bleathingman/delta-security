    ...
    <div class="max-w-4xl mx-auto px-6 py-10 space-y-8">
      ...
      <div class="fade-up flex items-end justify-between">
        ...
        <div class="text-right hidden sm:block">
          <p class="text-xs tracking-[0.15em] uppercase mb-1 font-body" style="color: #555;">Semaine actuelle</p>
      ...
      <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 fade-up delay-100">
        ...
        <div class="ds-card text-center">
          ...
          <p class="font-display text-4xl font-light" style="color: #F5F5F0;">{{ weeklyServices }}</p>
        </div>
        <div class="ds-card text-center">
          <p class="text-xs tracking-[0.15em] uppercase mb-2 font-body" style="color: #555;">Heures sem.</p>
          <p class="font-display text-4xl font-light" style="color: #D4AF37;">{{ weeklyHours }}</p>
        </div>
      </div>
      ...
      <div class="fade-up delay-200 ds-card"
        ...
        <!-- Subtle gold line at top when active -->
        ...
        <div class="flex flex-col sm:flex-row sm:items-center gap-6">
          ...
          <div class="flex-1">
            ...
            <div v-else>
              <p class="font-display text-2xl font-light mb-3" style="color: #888;">
                Prêt pour la mission
              </p>
              <div class="flex gap-3">
                <input v-model="missionLabel" type="text"
          ...
          <div class="shrink-0">
            <button v-if="!activeService"
                    ...
                    style="min-width: 180px; padding: 1rem 2rem; font-size: 0.875rem;">
...
const weekLabel = computed(() => {
  const start = dayjs().startOf('isoWeek').format('DD MMM')
  const end = dayjs().endOf('isoWeek').format('DD MMM')
  return `${start} — ${end}`
})
